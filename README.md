...
2026-09-10 기준 TCEU의 선정된 비민감 운영 KB·시험 결과 공유는 System Master Cloud 열람까지 완료했습니다. 공용 Skill 자동 전달·실제 호출도 통과했으나, 재로그온 자동 시작·개인 공유 회수·일반 실행 lease 연결은 잔여 검증으로 유지합니다.
